<div class="box box-info padding-1">
    <div class="box-body">
        ...
        <div class="form-group">
            {{ Form::label('num_ticket') }}
            {{ Form::text('num_ticket', $persona->num_ticket, ['class' => 'form-control' . ($errors->has('num_ticket') ? ' is-invalid' : ''), 'placeholder' => 'Num Ticket']) }}
            {!! $errors->first('num_ticket', '<div class="invalid-feedback">:message</div>') !!}
        </div>
        <div class="form-group">
