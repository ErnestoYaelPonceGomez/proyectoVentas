        ...
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            @if (Route::has('login'))
                <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                    @auth
                        <a href="{{ url('/home') }}" button type="button" class="btn" class="text-sm text-gray-700 dark:text-gray-500 underline">
                        <img src="{{ asset('images/house.svg') }}" style="width: 25px; height: 25px;" alt="...">
                        Home</a>
                    @else
                        <a href="{{ route('login') }}" button type="button" class="btn" class="text-sm text-gray-700 dark:text-gray-500 underline">
                        <img src="{{ asset('images/box-arrow-in-right.svg') }}" style="width: 25px; height: 25px;" alt="...">
                        Iniciar sesión</a>

                        @if (Route::has('register'))
                            <a href="{{ route('register') }}" button type="button" class="btn" class="ml-4 text-sm text-gray-700 dark:text-gray-500 underline">
