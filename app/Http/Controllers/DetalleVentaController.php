...
class DetalleVentaController extends Controller
{
    ...
    public function create()
    {
        ...
        $ventas = Venta::pluck('nombre','id');
        $articulos = Articulo::pluck('nombre','id');
        return view('detalle-venta.create', compact('detalleVenta','ventas','articulos'));
    }
    ...
    public function edit($id)
    {
        ...
        $ventas = Venta::pluck('nombre','id');
        $articulos = Articulo::pluck('nombre','id');
        return view('detalle-venta.edit', compact('detalleVenta','ventas','articulos'));
    }
